...
{
	I:`LK0020`,
	Q:`负责组织	A类和	B类业余无线电台所需操作技术能力的验证的机构是：`,
...
},
{
	...
	A:`绝对功率	d	Bm、低于载波发射功率的分贝值	d	B	c、低于PEP发射功率的相对值	d	B`,
	B:`绝对功率（瓦）`,
	C:`百分之几`,
	D:`千赫（或者赫芝）`
},
{
	I:`LK0125`,
	Q:`辐射（r	a	d	i	at	ion）是指任何源的能量流以无线电波的形式向外发出。正确的说法是：`,
	A:`闪电产生的电磁波干扰是一种辐射`,
...
{
	I:`LK0126`,
	Q:`发射（em	iss	ion）是指：由无线电发信电台产生的辐射或辐射产物。正确的说法是：`,
...
},
{
	...
	A:`完整的电台呼号，如在设台地以外的地点进行异地发射操作，还应在前面加上字母	B、操作地分区号和符号“/”`,
...
{
	I:`LK0079`,
	Q:`由国家无线电管理机构批准设台的北京火腿的电台呼号为	BH1	A	A	A，把电台带到西安去使用，则本台呼号应该为：`,
	A:`	B9/	BH1	A	A	A`,
	B:`	BH1	A	A	A/9`,
	C:`	B1/	BH9	A	A	A`,
	D:`	BH1	A	A	A/	B9`
...
{
	I:`LK0084`,
	Q:`某业余无线电爱好者，自己所设置的业余无线电台呼号为	BH1ZZZ。现该爱好者到业余无线电台	BH9YYY做客并在该台进行发射操作。应当使用的呼号为：`,
	A:`	BH9YYY或者	B9/	BH1ZZZ`,
	B:`	BH1ZZZ或者	B9/	BH1ZZZ`,
	C:`	BH1ZZZ/9或者	BH1ZZZ/	BH9`,
	D:`	BH9/	BH1ZZZ或者	BH1ZZZ`
},
{
	I:`LK0086`,
	Q:`某业余无线电爱好者，自己所设置的业余无线电台呼号为	BH1ZZZ。现该爱好者将自己的业余无线电台带到湖南进行异地发射操作。应当使用的呼号为：`,
	A:`	B7/	BH1ZZZ`,
	B:`	BH1ZZZ`,
	C:`	BH1ZZZ/	B7`,
	D:`	BH7/	BH1ZZZ`
...
{
	I:`LK0087`,
	Q:`某业余无线电爱好者，自己所设置的业余无线电台呼号为	BH1ZZZ。现该爱好者到业余无线电台	BH3YYY做客并并在该台进行发射操作。这种发射操作在业余无线电台管理中称为：`,
	A:`客席发射操作`,
	B:`异地发射操作`,
	C:`违章发射操作`,
	D:`移动发射操作`
...
{
	I:`LK0088`,
	Q:`某业余无线电爱好者，自己所设置的业余无线电台呼号为	BH1ZZZ。现该爱好者将自己的业余无线电台带到广东进行发射操作。这种发射操作在业余无线电台管理中称为：`,
	A:`异地发射操作`,
	B:`客席发射操作`,
	C:`违章发射操作`,
	D:`临时发射操作`
},
{
	...
	A:`	B3/	BH1ZZZ`,
	B:`固定台址发射操作用	BH1ZZZ，移动发射操用	B3/	BH1ZZZ`,
	C:`可任选使用呼号	B3/	BH1ZZZ或者	BH1ZZZ`,
	D:`	BH1ZZZ`
},
{
	I:`LK0056`,
...
},
{
	I:`LK0076`,
	Q:`法规和国际业余无线电惯例要求业余电台日志记载的必要基本内容是：`,
	A:`	D	ATE、T	IME、FRE	Q、MO	DE、	C	ALL（对方）、RST（双方）`,
	B:`	D	ATE、FRE	Q、	QTH（对方）、R	IG（对方）、RST（双方）、WX（对方）`,
	C:`	D	ATE、T	IME、MO	DE、	C	ALL（对方）、	QTH（对方）、RST（双方）`,
	D:`	C	ALL（通信对方）、T 	IME、FRE	Q、R	IG（对方）、RST（双方）、PWR（双方）`
},
{
	I:`LK1011`,
	Q:`填写和邮寄	QSL卡片时的正确做法有：`,
	A:`迫切需要方卡回寄卡片时，应直接向对方地址邮寄卡片并附加S	ASE`,
	B:`填写错误时应划去或使用涂改液覆盖错误内容并加以改正`,
	C:`自己的邮寄地址与电台的发射地点不同时，应在	QTH栏目内填明详细邮寄地址`,
	D:`通过卡片管理局寄出卡片并希望对方回卡时，应在卡片上注明PSE 	QSL 	D	IRE	CT`
},
{
	I:`LK1042`,
	Q:`关于	QSL卡片的正确用法是：`,
	A:`不是作为联络或收听证明而交换	QSL卡片时，应填上“Eye 	b	all 	QSO”等有关说明，不应赠送空白卡片`,
	B:`空白	QSL卡片可以当做照片或者名片，任意赠送、交换、散发`,
	C:`出于火腿互相帮助的目的，虽然对方没有联络到自己，也可以发去确认联络的	QSL卡片`,
	D:`如果在联络中没有听清对方呼号，可以在寄发	QSL卡片的对方台名栏中填写对方操作员姓名`
},
{
	I:`LK0034`,
...
},
{
	...
	A:`呼叫对方的呼号，并报出自己的呼号`,
	B:`呼叫“	bre	ak 	bre	ak”，然后说出对方的呼号`,
	C:`呼叫“	C	Q”三次，然后说出对方的呼号`,
	D:`等待，直到你要呼叫的电台呼叫	C	Q后，立刻回答他`
},
{
	I:`LK0074`,
...
},
{
	...
	A:`	C	all	ing you, Roger？`,
	B:`	Is the fre	quen	cy 	in use？`,
	C:`	Is 	any 	bo	dy 	in the fre	quen	cy？`,
	D:`	Any 	bo	dy here？`
},
{
	I:`LK0238`,
	Q:`业余电台	BH1ZZZ用话音发起	C	Q呼叫的正确格式为：`,
	A:`	C	Q、	C	Q、	C	Q。	BH1ZZZ呼叫。	Br	avo Hotel One Zulu Zulu Zulu呼叫，	BH1ZZZ呼叫。听到请回答。`,
	B:`	C	Q、	C	Q、	C	Q。听到请回答。`,
	C:`	C	Q、	C	Q、	C	Q。我是1ZZZ。听到请回答`,
	D:`	C	Q、	C	Q、	C	Q，	C	Q、	C	Q、	C	Q，	C	Q、	C	Q、	C	Q。	BH1ZZZ呼叫。请过来。`
},
{
	I:`LK0239`,
	Q:`业余电台	BH1ZZZ用话音发起	C	Q呼叫的正确格式为：`,
	A:`	C	Q 	C	Q 	C	Q.Th	is 	is 	BH1ZZZ. 	Br	avo Hotel One Zulu Zulu Zulu, 	BH1ZZZ 	is 	c	all	ing. 	I’m st	an	d	ing 	by.`,
	B:`	C	Q 	C	Q 	C	Q. Go 	ahe	a	d ple	ase.`,
	C:`	C	Q 	C	Q 	C	Q. Th	is One Zulu Zulu Zulu. Over.`,
	D:`	C	Q 	C	Q 	C	Q, 	C	Q 	C	Q 	C	Q, 	C	Q 	C	Q 	C	Q. Th	is 	is 	BH1ZZZ. 	B	a	ck to you.`
},
{
	I:`LK0241`,
	Q:`业余电台	BH1ZZZ用话音呼叫	BH8YYY的正确格式为：`,
	A:`	BH8YYY、	BH8YYY、	BH8YYY。	BH1ZZZ呼叫。	Br	avo Hotel One Zulu Zulu Zulu，	BH1ZZZ呼叫。听到请回答。`,
	B:`	BH8YYY。我是	BH1ZZZ，我是	BH1ZZZ，我是	BH1ZZZ。听到请回答。`,
...
},
{
	I:`LK0242`,
	Q:`业余电台	BH1ZZZ用话音呼叫	BH8YYY的正确格式为：`,
	A:`	Br	avo Hotel E	ight Y	ankee Y	ankee Y	ankee, 	Br	avo Hotel E	ight Y	ankee Y	ankee Y	ankee, 	Br	avo Hotel E	ight Y	ankee Y	ankee Y	ankee.Th	is 	is 	Br	avo Hotel One Zulu Zulu Zulu. 	Br	avo Hotel One Zulu Zulu Zulu, 	Br	avo Hotel One Zulu Zulu Zulu 	is 	c	all	ing. 	I’m st	an	d	ing 	by.`,
	B:`	Br	avo Hotel E	ight Y	ankee Y	ankee Y	ankee, 	Br	avo Hotel E	ight Y	ankee Y	ankee Y	ankee, 	Br	avo Hotel E	ight Y	ankee Y	ankee Y	ankee. Go 	ahe	a	d ple	ase.`,
	C:`	BH8YYY, 	BH8YYY, 	BH8YYY. Th	is One Zulu Zulu Zulu. 	Come 	in ple	ase.`,
	D:`8YYY, 8YYY, YYY. Th	is 	is 	BH1ZZZ. Over.`
},
{
	I:`LK0244`,
	Q:`	BH1ZZZ希望加入两个电台正在通信中的谈话，正确的方法为：`,
	A:`在双方对话的间隙，短暂发射一次“	Bre	ak 	in！”或“插入！”，如得到响应，再说明本台呼号 “	BH1ZZZ请求插入”，等对方正式表示邀请后，方能加入`,
	B:`在一方正在发射期间，短暂插入一次“	Bre	ak 	in”，向正在收听的一方发出插入请求`,
	C:`短暂发射一次“	Bre	ak 	in！”或“插入！”，如对方无反应，应加大功率反复作此发射`,
...
{
	I:`LK0313`,
	Q:`“我给你收据（	QSL卡片）、我已收妥”的业余无线电通信	Q简语为：`,
	A:`	QSL`,
	B:`	QRG`,
	C:`	QSX`,
	D:`	QRV`
...
{
	I:`LK0194`,
	Q:`已知UT	C时间，相应的北京时间应为：`,
	A:`UT	C时间的小时数加8，如小时数大于24，则小时数减24，日期改为后一天。`,
	B:`北京时间的小时数减8，如小时数小于0，则小时数加24，日期改为后一天。`,
	C:`北京时间的小时数加8，如小时数大于24，则小时数减24，日期改为前一天。`,
...
{
	I:`LK0204`,
	Q:`“	ITU分区”是	I	ARU的活动计算通信成绩的基础。我国所属的“	ITU分区”有：`,
	A:`33、42、43、44、50`,
	B:`33、42、43、44`,
	C:`23、24`,
	D:`23、24、27`
...
{
	I:`LK0862`,
	Q:`业余无线电通信梅登海德网格定位系统（M	a	i	denhe	a	d Gr	i	d S	qu	are Lo	c	ator）是一种：`,
...
},
{
	I:`LK0440`,
	Q:`直流电路欧姆定律是说：`,
	A:`流过电阻的电流	I，与两端的电压U成正比，与阻值R成反比`,
	B:`流过电阻的电流	I，与两端的电压U成正比，与阻值R成正比`,
	C:`流过电阻的电流	I，与两端的电压U成反比，与阻值R成反比`,
	D:`流过电阻的电流	I，与两端的电压U成反比，与阻值R成正比`
},
{
	I:`LK0512`,
...
{
	I:`LK0784`,
	Q:`业余无线电通信最常用的三种基本调制方法，其缩写	AM、FM和PM，它们的中文名称分别是：`,
...
{
	I:`LK0929`,
	Q:`某商品天线说明书给出的增益指标以	d	B	i为单位。其意义为：`,
...
{
	I:`LK0930`,
	Q:`某商品天线说明书给出的增益指标以	d	B	d为单位。其意义为：`,
...
{
	I:`LK0931`,
	Q:`某商品天线说明书给出的增益指标以	d	B为单位。其意义为：`,
...
{
	I:`LK0932`,
	Q:`两款VHF垂直全向天线，用作发射。甲天线增益4.5	d	B	d，乙天线增益为5.85	d	B	i。它们在远处某接收天线中形成的信号功率差为：`,
	A:`甲信号比乙信号强0.8	d	B`,
	B:`乙信号比甲信号强1.35	d	B`,
	C:`甲信号比乙信号强1.35	d	B`,
	D:`乙信号比甲信号强3.5	d	B`
...
{
	I:`LK0933`,
	Q:`两款VHF垂直全向天线，用作发射。甲天线增益2.9	d	B	d，乙天线增益为5.85	d	B	i。它们在远处某接收天线中形成的信号功率差为：`,
	A:`乙信号比甲信号强0.8	d	B`,
	B:`乙信号比甲信号强2.95	d	B`,
	C:`甲信号比乙信号强2.95	d	B`,
	D:`乙信号比甲信号强7.1	d	B`
...
{
	I:`LK1062`,
	Q:`以	d	B	d为单位的天线增益则是指：`,
	A:`最大辐射方向辐射功率密度与半波长振子最大辐射方向辐射功率密度之比的	d	B值`,
	B:`最大辐射方向辐射功率密度与理想点源天线最大辐射方向辐射功率密度之比的	d	B值`,
	C:`最大辐射方向辐射功率密度与1/4波长垂直接地天线水平方向辐射功率密度之比的	d	B值`,
	D:`最大辐射方向辐射功率密度与最小辐射方向辐射功率密度之比的	d	B值`
},
{
	I:`LK1063`,
	Q:`以	d	B	i为单位的天线增益则是指：`,
	A:`最大辐射方向辐射功率密度与理想点源天线最大辐射方向辐射功率密度之比的	d	B值`,
	B:`最大辐射方向辐射功率密度与半波长振子最大辐射方向辐射功率密度之比的	d	B值`,
	C:`最大辐射方向辐射功率密度与1/4波长垂直接地天线水平方向辐射功率密度之比的	d	B值`,
	D:`最大辐射方向辐射功率密度与最小辐射方向辐射功率密度之比的	d	B值`
},
{
...
{
	I:`LK0261`,
	Q:`某些对讲机具有发送	DTMF码的功能。缩写	DTMF指的是：`,
...
{
	I:`LK0262`,
	Q:`某些对讲机具有发送	CT	CSS码的功能。缩写	CT	CSS指的是：`,
...
{
	I:`LK1000`,
	Q:`安全电压是指不致使人直接致死或致残的电压。标准国家标准G	B3805－83《安全电压》，一般环境条件下允许持续接触的“安全特低电压”为：`,
	A:`24V`,
	B:`48V`,
	C:`72V`,
	D:`6V`
...
},
{
	...
	A:`国家标准G	B/T 51391《通信工程建设环境保护技术标准》`,
	B:`《业余电台管理办法》`,
	C:`国际非电离辐射防护委员会《限制时变电场和磁场暴露的导则》`,
	D:`美国F	C	C《射频电磁场人员暴露准则的测评方法规》`
},
{
	I:`LK1003`,
	Q:`按照我国国家标准G	B/T 51391《通信工程建设环境保护技术标准》，向没有屏蔽空间发射电磁场可以免于管理的有： `,
...
function reflush(){
	...
	const m = M[Math.floor(Math.random() * M.length)];
	document.getElementById("id").innerHTML=s.I;
	document.getElementById("question").innerHTML=s.Q;

	str = "option_"+m[0];
	document.getElementById(str).innerHTML=ABCD[m[0]]+s.A;
	document.getElementById(str).onclick=bingo;
	str = "option_"+m[1];
	document.getElementById(str).innerHTML=ABCD[m[1]]+s.B;
	document.getElementById(str).onclick=error;
	str = "option_"+m[2];
	document.getElementById(str).innerHTML=ABCD[m[2]]+s.C;
	document.getElementById(str).onclick=error;
	str = "option_"+m[3];
	document.getElementById(str).innerHTML=ABCD[m[3]]+s.D;
	document.getElementById(str).onclick=error;
